...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/		
		...
		function MouseWheelHandler(e) {
			...
			if(e.target.tagName == "svg" || e.target.tagName == "path" || e.target.tagName == "circle" 
				...
				|| e.target.className == "zoom_btn" || e.target.className == "arrow_image" || e.target.tagName == "TEXTAREA") {
				return;
			}
		...
		*/
		$.fn.fullpage.landscapeScroll =  function (slides, destiny){
		//function $.fn.fullpage.landscapeScroll(slides, destiny){
		...
		function doneResizing() {
			...
			$('.section').each(function(){
				...
				if (slides.length) {
					$.fn.fullpage.landscapeScroll(slides, slides.find('.slide.active'));
				}
			});
